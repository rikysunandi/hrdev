...
$(document).ready(function() {
    ...
    var table =  $('#datatable-daftar-talent').DataTable({
	destroy: true,
    ...
    columns: [
        ...
        { "data": "nama_grade"  ,width:"20" },
        { "data": "profesi"  ,width:"20" },
        { "data": "nama_pendidikan"  ,width:"20" },
        { "data": "aktif" }
    ], 
    deferRender: true,
	processing: true,
	responsive: true,
	"ajax": {
        "url": '/talent/daftar_talent/get-data',
        "type": "GET",
