...
$(document).ready(function() {
    ...
    var table =  $('#datatable-struktural-pensiun').DataTable({
	destroy: true,
            ...
            render: function (data, type, row) {
                ...
                return '<a class="table-edit" data-id="' + row[0] + '">'+
                			'<button type="button" class="btn btn-sm btn-outline-primary waves-effect waves-light">'+
                				'<i class="mdi mdi-account-check"></i> Mutasi'+
                			'</button></a>';
            }
        }
    ], 
	...
	processing: true,
	"ajax": {
        //"url": '/karir/struktural-pensiun/get-data',
        "type": "GET",
 ...
 //        }
    ...
    $('#btn_cari').click(function(){
    	...
    	table.ajax.url('/karir/akan-pensiun/get-data?ko1=01&ko2='+$('#ko_2').val()+'&ko3='+$('#ko_3').val()+'&ko4='+$('#ko_4').val()).load(
	    function(data) {
