...
$(document).ready(function() {
    ...
    var table =  $('#datatable-lama-menjabat').DataTable({
	destroy: true,
    ...
    columns: [
        { "data": "prev_per_no" },
        { "data": "personnel_number", "width": "15%"  },
        { "data": "nama_panjang_posisi", "width": "30%" },
        { "data": "personnel_subarea" },
        { "data": "jenjang", "width": "10%" },
        { "data": "tgl_jabat" },	
		{
            render: function (data, type, row) {
                ...
                return '<a class="table-edit" data-id="' + row[0] + '">'+
                			'<button type="button" class="btn btn-sm btn-outline-primary waves-effect waves-light">'+
                				'<i class="mdi mdi-account-check"></i> Definitif'+
                			'</button></a>';
            }
        }
    ], 
 ...
 //        }
    ...
    $('#btn_cari').click(function(){
    	...
    	table.ajax.url('/karir/lama-menjabat/get-data?ko1=01&ko2='+$('#ko_2').val()+'&ko3='+$('#ko_3').val()+'&ko4='+$('#ko_4').val()).load(
	    function(data) {
