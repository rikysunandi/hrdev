                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Daftar Struktural Lama Menjabat</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end row -->
                            ...
                            <div class="col-12">
                                <div class="card m-b-20">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable-lama-menjabat" class="table table-striped table-bordered dt-responsive" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead>
                                            <tr>
                                                <th>NIP</th>
                                                <th>Nama</th>
...
@section('script')
        ...
        <!-- Datatable init js -->
        <script src="{{ URL::asset('assets/pages/lama-menjabat.js')}}"></script>
@endsection